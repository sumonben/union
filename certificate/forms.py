...
class CertificateForm(forms.ModelForm):
    class Meta:
        model = Certificate
        fields = "__all__"
        exclude=['serial','name_en','email','transaction','is_verified','father_name_en','mother_name_en','passport','tracking_no','adress','cause','person','chairman','member','caste','income','profession','language']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['name']=forms.CharField(label='নাম', widget=forms.TextInput( attrs={'class':'textfieldUSERinfo',}))
        self.fields['phone']=forms.CharField(label='মোবাইল', widget=forms.TextInput( attrs={'class':'textfieldUSERinfo',}))
        self.fields['nid']=forms.CharField(required=False,label='জাতীয় পরিচয়/জন্ম নিবন্ধন', widget=forms.TextInput( attrs={'class':'textfieldUSERinfo','placeholder':'না থাকলে প্রয়োজন নেই'}))
        self.fields['father_name']=forms.CharField(label='বাবার নাম', widget=forms.TextInput( attrs={'class':'textfieldUSERinfo',}))
        self.fields['mother_name']=forms.CharField(label='মায়ের নাম', widget=forms.TextInput( attrs={'class':'textfieldUSERinfo',}))
