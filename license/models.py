...
class License(models.Model):
    ...
    nid=models.CharField(max_length=17,null=True,blank=True,verbose_name="জাতীয় পরিচপত্র/জন্ম নিবন্ধন")
    ...
    adress_of_license=models.ForeignKey(Adress,related_name='লাইসেন্সের ঠিকানা',null=True, blank=True,on_delete=models.SET_NULL,verbose_name="প্রতিষ্ঠানের ঠিকানা")
    place_of_license=models.CharField(max_length=500,blank=True, null=True,verbose_name="ব্যবসার স্থান")
    license_type=models.ForeignKey(LicenseType,on_delete=models.SET_NULL,null=True, blank=True,verbose_name="লাইসেন্সের ধরণ")
    license_no=models.CharField(max_length=500,blank=True, null=True,verbose_name="লাইসেন্স নং")
    ...
    profession=models.CharField(max_length=500,blank=True, null=True,verbose_name="ব্যবসার ধরণ")
